				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{url('customer/save-testimonials')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <!-- <strong><label class="text-danger">Add Reviews</label></strong> -->
                                        <textarea name="customer_content" class="form-control" cols="88" rows="10"></textarea>
                                    </div>
                                    ...
                                    </form>						<!-- <form action="{{route('payment')}}"method="Post">
