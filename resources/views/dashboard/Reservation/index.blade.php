...
@else
    ...
    @endif</td>
    <td>            
    <a href="{{ action('App\Http\Controllers\Admin\ReservationController@edit', $resers->id) }}" class="btn btn-warning" style="background: transparent; border: none;">
        <i class="fas fa-edit"></i> <!-- Edit icon -->
    </a>
         </td>

         <td>
    <form action="{{ action('App\Http\Controllers\Admin\ReservationController@destroy', $resers->id) }}" method="POST" onsubmit="return confirm('Are you sure')">
        @csrf
        @method('DELETE')
...
<td>  
    <a href="{{ route('reservation.pdf', ['id' => $resers->id]) }}" class="btn btn-primary">
