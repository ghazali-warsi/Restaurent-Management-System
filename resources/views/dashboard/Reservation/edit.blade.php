       ...
       <div class="inner_container">
          ...
          <div id="content">
             ...
             <!-- dashboard inner -->
              ...
              <div class="col-6">
              <h1>Edit Table</h1>
                <form action="{{action('App\Http\Controllers\Admin\ReservationController@update',$reservation->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
@method('put')
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="datetime-local" name="reservation_date" value="{{$reservation->reservation_date}}" class="form-control" placeholder="Name">
      ...
      <option value="{{$tables->id}}" @selected($tables->id == $reservation->table_id)>{{$tables->name}} ({{$tables->guest_number}}Guests)</option>
      @endforeach
</select>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="guest_number" value="{{$reservation->guest_number}}" class="form-control" placeholder="Name">
                @error('guest_number')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
