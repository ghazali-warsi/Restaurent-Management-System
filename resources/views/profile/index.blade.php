                                 ...
                                 <div class="row">
                                    ...
                                    @foreach($profiles as $profile)
                                       <div class="full dis_flex center_text">
                                          <div class="profile_img"><img width="180" class="rounded-circle" src="{{ asset('images/' . $profile->image) }}" alt="#" /></div>
                                             ...
                                             <div class="tabbar">
                                                <nav>
                                                   <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                      <a class="nav-item nav-link active" href="{{action('App\Http\Controllers\ProfileController@edit',$profile->id)}}">Edit Profile</a>
